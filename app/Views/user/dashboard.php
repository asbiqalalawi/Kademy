...
<body>
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
        <div class="container-fluid mx-5">
            ...
            <div class="dropdown">
                <a class="navbar-brand dropdown-toggle" href="#" style="font-size: 90%;" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hii, Asbiq Al Alawi</a>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button class="btn"><i class="fas fa-play mr-3" style="font-size: 70%;"></i>Lanjut belajar</button></td>
                        </tr>
                        <tr>
